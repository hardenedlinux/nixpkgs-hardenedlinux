...
{ fetchgit, fetchurl }:
{
  ...
  cudf = {
    pname = "cudf";
    version = "a02f888badcd9cf7f81a0e32605f51d51085311f";
    src = fetchgit {
      url = "https://github.com/rapidsai/cudf";
      rev = "a02f888badcd9cf7f81a0e32605f51d51085311f";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0jxsxvc7g00a6m0wyr8s0bydi1lv02z475nmzl55vxqh57y0hrym";
    };
  };
  durationpy = {
    pname = "durationpy";
  ...
  zed = {
    pname = "zed";
    version = "d10df299c6835d0c545ba2940f607be7299e1ceb";
    src = fetchgit {
      url = "https://github.com/brimdata/zed";
      rev = "d10df299c6835d0c545ba2940f607be7299e1ceb";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0rya909hra9r78112yqxjhy02rmvwri3yg4w1gn0b3f458n6s4k4";
    };
  };
}
