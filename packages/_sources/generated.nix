...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fastai = {
    pname = "fastai";
    version = "1c10d4743535be64f573668178edc634a6115f27";
    src = fetchFromGitHub ({
      owner = "fastai";
      repo = "fastai";
      rev = "1c10d4743535be64f573668178edc634a6115f27";
      fetchSubmodules = false;
      sha256 = "sha256-HyNtjnbDcSX2PfToNx17yov/2VbwpSB4lPjJXxZWtYI=";
    });
  };
  fastcore = {
    pname = "fastcore";
  ...
  zed = {
    pname = "zed";
    version = "1023450545ec2ae7033619e133a1dfc86e997c88";
    src = fetchFromGitHub ({
      owner = "brimdata";
      repo = "zed";
      rev = "1023450545ec2ae7033619e133a1dfc86e997c88";
      fetchSubmodules = false;
      sha256 = "sha256-O2+cWTFurJUGAv40x7b4LM/+Lu4RXMFTOOSzIzRLAEg=";
    });
  };
  zeekscript = {
    pname = "zeekscript";
    version = "c3d39ed223512a82acb71110a9be3a498b9edb35";
    src = fetchFromGitHub ({
      owner = "zeek";
      repo = "zeekscript";
      rev = "c3d39ed223512a82acb71110a9be3a498b9edb35";
      fetchSubmodules = true;
      sha256 = "sha256-3tdF6UblLgHM59XIuHrsJODVME3J4KffAqbAGhrkAuo=";
    });
  };
}
