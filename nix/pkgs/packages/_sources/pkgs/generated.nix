...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  chatgpt-next-web = {
    ...
    version = "cf220dd2eb08589c7bd99b5a2c05eddf8f2e106f";
    src = fetchFromGitHub {
      owner = "Yidadaa";
      repo = "ChatGPT-Next-Web";
      rev = "cf220dd2eb08589c7bd99b5a2c05eddf8f2e106f";
      fetchSubmodules = false;
      sha256 = "sha256-3OX69hz/8TeKxCSFOnWlm6fwq/KvXd8juVQ6Lq8UGyk=";
    };
    date = "2023-11-17";
  };
  chatgpt-web = {
  ...
  nix-unstable-installer = {
    ...
    version = "nix-2.19.0pre20231103_8e222fb";
    src = fetchurl {
      url = "https://github.com/numtide/nix-unstable-installer/releases/download/nix-2.19.0pre20231103_8e222fb/install";
      sha256 = "sha256-uCzE4/gmrTWUXVURarKfpXm2JcvwgoRGzzRFgLwUip4=";
    };
  };
  osquery = {
    pname = "osquery";
  ...
  zeek-language-server = {
    ...
    version = "77510e2ed82cd73e3288a235b24584085bd16647";
    src = fetchFromGitHub {
      owner = "bbannier";
      repo = "zeek-language-server";
      rev = "77510e2ed82cd73e3288a235b24584085bd16647";
      fetchSubmodules = true;
      sha256 = "sha256-scesTxB4euTUzGGg/Eh2dvd8Kg6hQLplgoxFPhjUWZw=";
    };
    date = "2023-11-14";
  };
}
